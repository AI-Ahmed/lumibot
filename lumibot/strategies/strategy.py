...
class Strategy(_Strategy):
    ...
    def get_position(self, asset: Union[str, Asset]):
        ...
        ----------
        asset : Asset or str
            Asset object whose traded position is sought.

        Returns
        -------
        Position or None
            A position object for the asset if there is a tracked position,
            or None if no tracked position exists.
    ...
    def _compute_multileg_net_best_fastest(self, child_orders: List[Order]) -> tuple[float, float] | None:
        ...
        Convention (matches SMART_LIMIT logic):
    ...
    def get_last_price(self, asset: Union[Asset, str], quote=None, exchange=None) -> Union[float, Decimal, None]:
        ...
        try:
            ...
            # fetches are expensive (IBKR). Keep Yahoo/Alpaca on legacy behavior.
